...
@section('content')
    ...
    {{-- doppio controllo per i buttons edit e delete --}}
    {{-- l'utente NON deve essere guest --}}
    @if(!Auth::guest())
      {{-- l'utente corrente deve avere lo stesso id registrato sotto user_id nel post corrente --}}
